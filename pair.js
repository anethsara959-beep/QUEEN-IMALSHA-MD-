...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/4LSss7R/tourl-176664170069.jpg',
...
││ ${topLines}
││ 🤖 *Bot Name*: ${title}
││ 👑 *Owner*: ${config.OWNER_NAME || '𝐎𝐥𝐝 𝐒𝐚𝐧𝐮 𝐗𝐝 𝐎𝐰𝐧𝐞𝐫'}
...
case 'owner': {
  try {
    ...
    let vcard = 
      ...
      'TEL;type=CELL;type=VOICE;waid=94785893445:+94725146104\n' + // Second Number (Owner)
      'END:VCARD';
