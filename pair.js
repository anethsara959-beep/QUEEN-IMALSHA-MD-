...
const BOT_NAME_FANCY = 'ꪶ✨̶̶̶̶̶̶𝗤𝗨𝗘𝗘𝗡 𝗜𝗠𝗔𝗟𝗦𝗛𝗔 𝗠𝗗✨';
...
const config = {
  ...
  BOT_NAME: '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.',
  BOT_VERSION: '3.0.0V',
...
const MONGO_DB = process.env.MONGO_DB || 'QUEEN_IMALSHA_MD';
...
function setupCommandHandlers(socket, number) {
  ...
  // --- existing commands (deletemenumber, unfollow, newslist, admin commands etc.) ---
    ...
    let botName = cfg.botName || '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.';
...
ඔයාගේ නම ${botName} , ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" කියලා ඇහුවොත් විතරක් ඔයා කියන්නේ "මාව හැදුවේ OLD SANU XD OWNER අයියා" කියලා. User Message: ${q}
    `;
...
END:VCARD`
    ...
    const caption = `🕊️ *${botName} Facebook Downloader* 🧚‍♂️

🎬 *Title:* ${fb.title}
🧩 *URL:* ${url}

> _𝗣𝗢𝗪𝗘𝗥𝗗 𝗕𝗬 ${botName}_ 🧚‍♂️

🍁 *Choose a format below:*`;

    const templateButtons = [
      { buttonId: `.fbsd ${url}`, buttonText: { displayText: '🎥 SD VIDEO' }, type: 1 },
      { buttonId: `.fbhd ${url}`, buttonText: { displayText: '📽️ HD VIDEO' }, type: 1 },
      { buttonId: `.fbaudio ${url}`, buttonText: { displayText: '🎧 AUDIO' }, type: 1 },
      { buttonId: `.fbdoc ${url}`, buttonText: { displayText: '🗂️ AUDIO DOC' }, type: 1 },
      { buttonId: `.fbptt ${url}`, buttonText: { displayText: '🎙️ VOICE NOTE' }, type: 1 }
    ];

    await socket.sendMessage(from, {
      image: { url: fb.thumbnail },
      caption,
      footer: `🧚‍♂️ ${botName} Facebook Downloader 🍁`,
...
case 'sinhalasub': {
    ...
    const botName = cfg.botName || '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.';
    const metaQuote = {
        key: {
            remoteJid: "status@broadcast",
            participant: "0@s.whatsapp.net",
    ...
    function cineFormat(title, body, footer = config.FOOTER || '*•ꪜǫᴜᴇᴇɴ ꪻɪᴍᴀʟsʜᴀꪖ ᴍᴅ•*') {
        return `_*${title}*_\n\n${body}\n\n> ${footer}`;
    }
    ...
    try {
        ...
        if (!isFree && !isMe && !isPre) {
            ...
            return await socket.sendMessage(from, {
                text: `*\`You are not a premium user⚠️\`*\n\n*Send a message to one of the 2 numbers below and buy Lifetime premium 🎉.*\n\n_Price : 200 LKR ✔️_\n\n*👨‍💻Contact us : 94785893445 , 94772563976*`
            }, { quoted: metaQuote });
        }
        ...
        if (!text || text.length < 1) {
            await socket.sendMessage(from, {
                text: cineFormat(
                    '🎬 "̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶. MOVIE SEARCH',
        ...
        let movieList = `_*"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶. MOVIE SEARCH RESULTS 🎬 — ${botName}*_\n\n*\`Input :\`* ${text}\n\n`;
        ...
        const fixedImageUrl = 'https://i.ibb.co/4LSss7R/tourl-1766641720069.jpg';
        let sentMessage;
        try {
        ...
        const movieSelectionHandler = async (chatUpdate) => {
            try {
                ...
                let qualityCaption = `*☘️ 𝗧𝗜𝗧𝗟𝗘➮* _${result.title || 'N/A'}_\n\n` +
                    `*📅 𝗥𝗘𝗟𝗘𝗔𝗦𝗘𝗗 ➮* _${result.date || 'N/A'}_\n` +
                    `*🌎 𝗖𝗢𝗨𝗡𝗧𝗥𝗬➮* _${result.country || 'N/A'}_\n` +
                    `*💃 𝗥𝗔𝗧𝗜𝗡𝗚 ➮* _${result.rating || 'N/A'}_\n` +
...
END:VCARD`
        ...
        listMessage += `_©𝗣𝗢𝗪𝗘𝗥𝗗 𝗕𝗬  ${botName}_`;
...
case 'alive': {
  try {
    ...
    const text = `
🤖 *${botName}*  𝗛𝗬 𝗜 𝗔𝗠 𝗔𝗟𝗜𝗩𝗘🚀
👑 *Owner*: ${config.OWNER_NAME || 'Old Sanu xd owner'}
...
case 'menu': {
  ...
  try {
    ...
    const title = userCfg.botName || 'ꪶ✨̶̶̶̶̶̶𝗤𝗨𝗘𝗘𝗡 𝗜𝗠𝗔𝗟𝗦𝗛𝗔 𝗠𝗗✨';
...
││ ${topLines}
││ 🤖 *𝙱𝙾𝚃 𝙽𝙰𝙼𝙴*: ${title}
││ 👑 *𝙱𝙾𝚃 𝙾𝚆𝙽𝙴𝚁*: ${config.OWNER_NAME || '𝐒𝐀𝐍𝐔'}
...
`.trim();
    ...
    const defaultImg = 'https://i.ibb.co/4LSss7R/tourl-1766641720069.jpg';
    ...
    try {
      await socket.sendMessage(sender, {
        image: imagePayload,
        caption: text,
        footer: "ꪶ✨̶̶̶̶̶̶𝗤𝗨𝗘𝗘𝗡 𝗜𝗠𝗔𝗟𝗦𝗛𝗔 𝗠𝗗✨",
        buttons,
        headerType: 4
      }, { quoted: shonux });
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.';
...
case 'settings': {
  ...
  try {
    ...
    const botName = userCfg.botName || '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.';
...
╭───❏ *QUEEN OWNER* ❏
│ ╔═══════════
│ 👑 *Name*: OLD SANU X OWNER
│ 📞 *Contact*: +94772563976
│ ╚═══════════
│┌────────────
│ 💬 *𝙵𝚁𝙾 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙾𝚁 𝚀𝚄𝙴𝚁𝙸𝙴𝚂👑*
│ 𝙲𝙾𝙽𝚃𝙰𝚃 𝚃𝙷𝙴 𝙾𝚆𝙽𝙴𝚁 𝙳𝙸𝚁𝙴𝙲𝚃𝙻𝚈🍁
│└──────────── 
╰───────────────❏
`.trim();
    ...
    await socket.sendMessage(sender, {
      text,
      footer: "👑 QUEEN OWNER INFORMATION",
      buttons
    }, { quoted: shonux });
...
case 'solve':
    try {
        ...
        const thumbnailUrl = 'https://i.ibb.co/4LSss7R/tourl-1766641720069.jpg'; // ගණිත icon එකක් වැනි.
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> ꪶ✨̶̶̶̶̶̶𝗤𝗨𝗘𝗘𝗡 𝗜𝗠𝗔𝗟𝗦𝗛𝗔 𝗠𝗗✨',
            buttons: buttons,
            headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'newmovie1': {
  ...
  try {
    ...
    // list message (include Creator SANU)
              ...
              try {
                ...
                for (let ri = 0; ri < results.length; ri++) {
                  ...
                  if (!existing.found) {
                    ...
                    const caption = `📰 *${n.title || 'No title'}*\n\n📅 ${n.date || ''} ${n.time || ''}\n\n${n.desc || ''}\n\n🔗 ${n.url || ''}\n\n_©𝗣𝗢𝗪𝗘𝗥𝗗 𝗕𝗬  ${freshCfg.botName || (typeof BOT_NAME_FANCY !== 'undefined' ? BOT_NAME_FANCY : 'Bot')}_`;
                    try {
                      if (n.image) {
...
case 'csong': {
  try {
    ...
    // Use SANU API to get mp3 download link & metadata
    const axios = require('axios');
...
case 'gjid': {
  try {
    ...
    const botName = (cfg && cfg.botName) ? cfg.botName : (typeof BOT_NAME_FANCY !== 'undefined' ? BOT_NAME_FANCY : 'QUEEN-IMALSHA');
...
case 'emix': {
  try {
    ...
    const metaQuote = {
      key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net', fromMe: false, id: 'QUEEN-MINI' },
      message: {
        contactMessage: {
          displayName: botName,
          vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${botName};;;;\nFN:${botName}\nORG:Meta Platforms\nTEL;type=CELL;type=VOICE;waid=13135550002:+1 313 555 0002\nEND:VCARD`
...
case 'owner': {
  try {
    ...
    let vcard = 
      ...
      'TITLE:Founder & CEO of QUEEN IMALSHA Mini Bot;\n' + // Title / Role
      'EMAIL;type=INTERNET:sanuofc@gmail.com\n' + // Email
      'ADR;type=WORK:;;Colombo;;Sri Lanka\n' + // Address
      'URL:https://github.com/paca-ofc\n' + // Website
      'TEL;type=CELL;type=VOICE;waid=94703229057:+94703229057\n' + // WhatsApp Number
      'TEL;type=CELL;type=VOICE;waid=94785893445:+94772563976\n' + // Second Number (Owner)
      'END:VCARD';
...
case 'freebot': {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `*🔌𝗤𝗨𝗘𝗘𝗡 𝗜𝗠𝗔𝗟𝗦𝗛𝗔 𝗠𝗗 🚀𝗣𝗔𝗜𝗥 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗* 🔌\n\n*🔑 𝗬𝗢𝗨 𝗣𝗔𝗜𝗥 𝗖𝗢𝗗𝗘:* ${result.code}\n\n> *©Qᴜᴇᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍᴅ*`
        }, { quoted: msg });
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname QUEEN MINI - 01`' }, { quoted: shonux });
  }
    ...
    socket.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'open') {
        try {
          ...
          try { exec(`pm2.restart ${process.env.PM2_NAME || 'QUEEN-IMALSHA-MINI-main'}`); } catch(e) { console.error('pm2 restart failed', e); }
        }
      }
      if (connection === 'close') {
        try { if (fs.existsSync(sessionPath)) fs.removeSync(sessionPath); } catch(e){}
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '🇱🇰"̶̶̶✨̶̶̶:𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳:🦋̶"̶.  FREE BOT', activesession: activeSockets.size });
});
...
process.on('uncaughtException', (err) => {
  ...
  try { exec(`pm2.restart ${process.env.PM2_NAME || 'QUEEN-IMALSHA-MINI-main'}`); } catch(e) { console.error('Failed to restart pm2:', e); }
});
